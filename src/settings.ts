 ...
 */
export const PLATFORM_NAME = 'YoLink';

/**
 * This must match the name of your plugin as defined the package.json
 */
export const PLUGIN_NAME = 'homebridge-yolink';

/**
 * Default values for accessing YoLink server API.
 */
export const YOLINK_MQTT_PORT = 8003;
