...
export const initDeviceService = {
  ...
  SmokeAlarm(this: YoLinkPlatformAccessory)         { initCoSmokeDetector.bind(this)(); },
...
export const mqttHandler = {
  ...
  SmokeAlarm(this: YoLinkPlatformAccessory, data)      { mqttCoSmokeDetector.bind(this)(data); },
